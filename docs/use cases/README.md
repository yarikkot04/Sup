...
### На рис. 2.1 зображені усі можливості гостя
...
**Рис.6.2** Сценарій редагування проекту.
...
@startuml
    ...
    |Користувач|
      :отримує повідомлення про успішне видалення проекту;
     stop;
@enduml
...
@startuml
    ...
    |Користувач|
      :отримує повідомлення про успішне додавання учасника до проекту;
    stop;
...
@startuml
    ...
    |Користувач|
       :отримує повідомлення про успішне відредагування завдання;
    stop;
@enduml
...
@startuml
    ...
    |Користувач|
       :отримує повідомлення про успішне призначення виконавця;
     stop;
@enduml
...
@startuml
    ...
    |Система|
       ...
       :змінює статус завдання;
    |Користувач|
       :отримує повідомлення про успішне змінення статусу;
     stop;
@enduml
...
@startuml
    ...
    |Менеджер|
      :отримує повідомлення про необхідність надати допомогу;
    |Користувач|
      :бачить статус запиту "Чекає на допомогу";
    stop;
...
@startuml
    ...
    |Менеджер|
      :отримує повідомлення про запит на призначення відповідальної особи;
    |Користувач|
      :отримує повідомлення від системи;
    stop;
...
@startuml
    ...
    |Користувач|
        :отримує повідомлення про зміну запиту;
       stop;   
...
@startuml
    ...
    |Користувач|
     start
      :повідомляє про необхідність змін;
      :вказує причину відхилення;
    |Система|
      :перевіряє дані, вказані користувачем;
       note right #ffaaaa
       Необхідні дані не заповнено вірно
       end note
      :приховує дані з бази даних і переміщує на "Відхилено";
       note right #ffaaaa
       Запит не зареєстровано
       end note
    |Користувач|
      :отримує повідомлення про статус запиту "Відхилено";
    stop;
...
@startuml
    ...
    |Система|
      ...
      :видаляє задачу;
    |Користувач|
      :отримує повідомлення про видалення задачі;
     stop;
...
**Рис. 6.14** Сценарій авторизації користувача
...
**Рис. 6.17** Сценарій відхилення запиту.
...
**Рис. 6.18** Cценарій загрузки з резервної копії даних.
